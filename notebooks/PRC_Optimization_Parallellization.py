...
def run_single_init(args):
    ...
    try:
        ...
        print(f"[Init {idx+1}] Starting fit...")
        ...
        print(f"→ Parameters: a={a:.3f}, b={b:.3f}, g={g:.3f}, h={h:.3f}, v={v:.3f}\n")

        return dict(success=True, rmse=rmse, r2=r2,
                    params=dict(a=a, b=b, g=g, h=h, v=v))
